...
/* ---- Paleta MetOn v1.0 ----
   Os nomes antigos foram mantidos de proposito: as 211 chamadas espalhadas
   pelo app continuam funcionando, ja apontando para as cores da marca.
   DARK      base grafite
   LIGHT     verde sinal  -> entradas, marca, destaque
   NUDE      nevoa        -> fundo de pagina
   NUDE_DEEP ambar profundo -> saidas (contraparte do verde nos graficos)
*/
