...
function patchMetonStable() {
  return {
    ...
    transform(code, id) {
      ...
      const required=["TransactionsV2","CardsPage","AuditPage","RemindersPage","ReportsV2","ReminderWatcher","ImportPageV2","RadarExecutive","<RadarExecutive tx={tx}/>","const ctrl=calcController"];
